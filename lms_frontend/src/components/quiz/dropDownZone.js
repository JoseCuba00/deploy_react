    ...
    return (
        <div className='d-inline-flex'>
            <Dropdown className="d-inline-block" >
                <Dropdown.Toggle id="dropdown-basic" className='pt-2 pb-3 font-italic btn-sm fixed-width-toggle' disabled={props.disabled} style={{ background: 'rgb(167, 185, 219)', 'border-radius': '5px' ,'fontWeight': '600' }}>
                    {props.title[props.boxIndex]['title']}
                </Dropdown.Toggle>
